...
public abstract class AbstractCaseNodeHandler extends BaseAbstractHandler implements Handler {
    ...
    protected void loadDataInputsAndOutputs(final Element element, Map<String, String> inputs, Map<String, String> outputs, Map<String, String> inputTypes, Map<String, String> outputTypes, final ExtensibleXmlParser parser) {
        ProcessBuildData buildData = (ProcessBuildData) parser.getData();
