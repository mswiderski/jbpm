...
public class BatchPostgresSQLJDBCDelegate extends PostgreSQLDelegate {
    
    private int batchSize = Integer.parseInt(System.getProperty("org.jbpm.timer.quartz.batch.size", "50"));

    public BatchPostgresSQLJDBCDelegate(Logger logger, String tablePrefix, String instanceId) {
        super(logger, tablePrefix, instanceId);
    }

    public BatchPostgresSQLJDBCDelegate(Logger logger, String tablePrefix, String instanceId, Boolean useProperties) {
